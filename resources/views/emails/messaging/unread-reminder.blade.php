...
<title>Unread Messages — {{ $appName }}</title>
</head>
        ...
        <tr>
          <td style="padding:32px 32px 24px;">
            ...
            <p style="margin:0 0 20px;font-size:14px;color:#4b5563;line-height:1.6;">
              You have <strong>{{ $unreadCount }} unread {{ $unreadCount === 1 ? 'message' : 'messages' }}</strong>
              waiting in {{ $conversationCount }} {{ $conversationCount === 1 ? 'conversation' : 'conversations' }}.
            </p>
